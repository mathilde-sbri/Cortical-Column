...
# MODIFIED: Use gamma-fix connectivity files
csv_layer_configs, _INTER_LAYER_CONNECTIONS, _INTER_LAYER_CONDUCTANCES = load_connectivity_from_csv(
    'config/connection_probabilities2_gamma_fix.csv',  # CHANGED
    'config/conductances_AMPA2_gamma_fix.csv',         # CHANGED
    'config/conductances_NMDA2_alpha_v2.csv'           # Keep same NMDA
)
