...
MU_VIP = N_VIP * vip_rate * TAU_S * abs(w_vip_to_SOM)

mu_bg_base = {'E': 3.0*mV, 'PV': 3.0*mV, 'SOM': 7.0*mV}
mu_bg = dict(mu_bg_base)
mu_bg['SOM'] = mu_bg_base['SOM'] - MU_VIP
...
_LAYER_CONFIGS = {
    ...
    'L23_surround1': {
        'connection_prob': P_conn_same,
        'input_rate': None,
        'neuron_counts': { 'E': N_E, 'PV': N_PV, 'SOM': N_SOM },
        'poisson_inputs': {},
    },
}

_INTER_LAYER_CONNECTIONS = {
    ('L23', 'L23_surround1'): {'E_E': 0.02, 'E_PV': 0.03, 'E_SOM': 0.08},
    ('L23_surround1', 'L23'): {'E_E': 0.02, 'E_PV': 0.03, 'E_SOM': 0.08}
}
