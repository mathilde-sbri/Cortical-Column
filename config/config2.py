...
_LAYER_CONFIGS = {
    'L23': {
        ...
        'input_rate': 3*Hz,
        'neuron_counts': {'E': 3520, 'PV': 264, 'SOM': 334, 'VIP': 282},
        'coordinates' : {
            'x': (-0.15,0.15),
            'y': (-0.15,0.15),
            'z': (0.45, 1.1),
    ...
    'L4AB': {
        ...
        'poisson_inputs': {
            ...
            'PV_NMDA':  {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 22},
            'SOM_NMDA': {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 14},
            'VIP_NMDA': {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 14},
        },
        'input_rate': 3*Hz,
    ...
    'L4C': {
        ...
        'poisson_inputs': {
            ...
            'VIP_NMDA': {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 10},
        },
        'input_rate': 5*Hz,
    ...
    'L6': {
        ...
        'poisson_inputs': {
            'E':        {'target': 'gE_AMPA', 'weight': 'EXT_AMPA', 'N': 60},
            'PV':       {'target': 'gE_AMPA', 'weight': 'EXT_AMPA', 'N': 40},
            'SOM':      {'target': 'gE_AMPA', 'weight': 'EXT_AMPA', 'N': 18},
            'VIP':      {'target': 'gE_AMPA', 'weight': 'EXT_AMPA', 'N': 8},
            'E_NMDA':   {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 60},
            'PV_NMDA':  {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 20},
            'SOM_NMDA': {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 18},
            'VIP_NMDA': {'target': 'gE_NMDA', 'weight': 'EXT_NMDA', 'N': 14},
        },
        'input_rate': 5*Hz,
        'neuron_counts': {'E': 2040, 'PV': 162, 'SOM': 126, 'VIP': 72},
        'coordinates' : {
            'x': (-0.15,0.15),
            'y': (-0.15,0.15),
            'z': (-0.62, -0.34),
